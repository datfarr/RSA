...
// ПРИМЕЧАНИЕ! ЧИСЛА p И q ДОЛЖНЫ БЫТЬ ОДИНАКОВОГО РАЗМЕРА!!! КОЛИЧЕСТВО ЦИФР ДОЛЖНЫ БЫТЬ ОДИНАКОВЫМИ !!!
 do {
...
printf(" найден закрытый ключ e= %d\n", e);
